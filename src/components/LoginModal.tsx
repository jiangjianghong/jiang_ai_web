  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 select-none">
      ...
      >
        ...
        {displayError && (
          <div className="mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded select-none">
            {displayError}
          </div>
        )}

        {successMessage && (
          <div className="mb-4 p-3 bg-green-100 border border-green-400 text-green-700 rounded select-none">
            {successMessage}
          </div>
        )}
        ...
        <div className="mt-4">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500 select-none">或</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full bg-red-500 hover:bg-red-600 disabled:bg-gray-400 text-white py-2 px-4 rounded-md transition-colors flex items-center justify-center select-none"
          >
            <i className="fab fa-google mr-2 select-none"></i>
            <span className="select-none">使用 Google 登录</span>
          </button>
        </div>
        ...
        {showVerificationMessage && (
          ...
          >
            <div className="flex items-start space-x-2">
              <i className="fa-solid fa-envelope-circle-check text-green-600 mt-0.5 select-none"></i>
              <div>
                <h4 className="text-sm font-medium text-green-800 select-none">
                  注册成功！请验证您的邮箱
                </h4>
                ...
                <div className="mt-3 flex space-x-2">
                  <button
                    ...
                    className="text-xs bg-green-100 hover:bg-green-200 text-green-800 px-2 py-1 rounded select-none"
                  >
                    重新发送验证邮件
                  </button>
                  <button
                    ...
                    className="text-xs bg-blue-100 hover:bg-blue-200 text-blue-800 px-2 py-1 rounded select-none"
                  >
                    返回登录
                  </button>
                </div>
