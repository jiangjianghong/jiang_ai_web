      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Notion 设置指南</h3>
              <p className="text-sm text-gray-500">详细步骤帮您快速配置工作空间</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-3xl space-y-8">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h4 className="text-lg font-semibold text-orange-900 mb-3">配置工作空间连接</h4>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
            <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
              <i className="fa-solid fa-question-circle mr-2 text-gray-600"></i>
              常见问题
            </h4>
            <div className="space-y-4">
              ...
              <div>
                <h5 className="font-medium text-gray-800 mb-1">Q: 数据同步不完整？</h5>
                <p className="text-sm text-gray-600">
